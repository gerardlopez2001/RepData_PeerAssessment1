...
The mean total number of steps taken per day is `r StepsByDayMean`.

The median total number of steps taken per day is `r StepsByDayMedian`.
...
The 5-minute interval on average across all the days in the dataset which contains the maximum number of steps is `r MaxStepInterval`. 
...
The number of rows with NA missing values is `r rowsWithNAs`.
...
The mean total number of steps taken per day in the imputed data is `r StepsByDayImputedMean`.

The median total number of steps taken per day in the imputed data is `r StepsByDayImputedMedian`.
